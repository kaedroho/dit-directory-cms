    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_proposition', core.model_fields.MarkdownField(verbose_name='Body text')),
                ('contact_button', models.CharField(max_length=500)),
                ('proposition_one', core.model_fields.MarkdownField()),
                ('opportunity_list_title', models.CharField(max_length=300)),
                ('opportunity_list_item_one', core.model_fields.MarkdownField()),
                ('opportunity_list_item_two', core.model_fields.MarkdownField()),
                ('opportunity_list_item_three', core.model_fields.MarkdownField(blank=True)),
                ('proposition_two', core.model_fields.MarkdownField()),
                ('proposition_two_list_item_one', core.model_fields.MarkdownField()),
                ('proposition_two_list_item_two', core.model_fields.MarkdownField()),
                ('proposition_two_list_item_three', core.model_fields.MarkdownField()),
                ('competitive_advantages_title', models.CharField(max_length=300, verbose_name='Body text')),
                ('competitive_advantages_list_item_one', core.model_fields.MarkdownField()),
                ('competitive_advantages_list_item_two', core.model_fields.MarkdownField()),
                ('competitive_advantages_list_item_three', core.model_fields.MarkdownField()),
                ('testimonial', core.model_fields.MarkdownField(blank=True)),
                ('companies_list_text', core.model_fields.MarkdownField()),
                ('case_study_list_title', models.CharField(max_length=300)),
                ('case_study_one_text', core.model_fields.MarkdownField(blank=True)),
                ('case_study_two_text', core.model_fields.MarkdownField(blank=True)),
                ('case_study_three_text', core.model_fields.MarkdownField(blank=True)),
                ('case_study_four_text', core.model_fields.MarkdownField(blank=True)),
